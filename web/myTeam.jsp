        ...
        <div class="">
            <div class="container extraClass  ">
                <ul class="nav nav-tabs extraClassul">
                    ...
                    <li class="active"><a href="myTeam.jsp">My Team</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 top-gap">
                        <div class="row ">
                            ...
                            <button type="button" class="prevbutton btncustom col-sm-3 hidden-xs" style="height: 33px; font-size: 13px; font-weight: bold; text-align: center; font-family:Century Gothic">
                                Previous
                            </button>
                            <h4 class="col-sm-6 hidden-xs" style="text-align: center;font-weight: bold; font-family:Century Gothic;font-size:22px;left: 8% ">
                                Gameweek 24
                            </h4>
                            <button type="button" class="btncustom nextbtn col-sm-3 hidden-xs" style="height: 33px; font-size: 13px; font-weight: bold; text-align: center; font-family:Century Gothic">
                                Next
                            </button>
