                            ...
                            <div>
                                <table style="width:100%; background-color: #f9f5f5" id='gk'>
                                    ...
                                    <tr id='gk1' data-toggle="modal" style='cursor:pointer' onclick="openModalGK(1)">
                                        ...
                                        <td style=" font-family: Century Gothic;text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="gkname1" style="font-family: Century Gothic;font-size: 15px " ><%=gkname.get(0)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="gkteam1" style="font-family: Century Gothic;font-size: 12px; font-weight: lighter "><%=gkteam.get(0)%></span>
                                            </div>
                                        </td>
                                        <td id="gkprice1" style="font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%= gkprice.get(0)%></td>
                                        <td id="gkscore1" style="font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%= gkscore.get(0)%></td>
                                    </tr>
                                    <tr id='gk2' style='cursor:pointer' onclick="openModalGK(2)">
                                        ...
                                        <td style=" font-family: Century Gothic;text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="gkname2" style="font-family: Century Gothic; font-size: 15px; "><%=gkname.get(1)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="gkteam2" style="font-family: Century Gothic; font-size: 12px; font-weight: lighter "><%=gkteam.get(1)%></span>
                                            </div>
                                        </td>
                                        <td id="gkprice2" style=" font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%= gkprice.get(1)%></td>
                                        <td id="gkscore2" style=" font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%= gkscore.get(1)%></td>
                                    </tr>
                                    <%
                                        String gkstr;
                                        String gkimagestr;
                                    ...
                                    <tr id='<%=gkstr%>' style='display:none;cursor:pointer' onclick="openModalGK(<%=i%>)">
                                        ...
                                        <td style=" font-family: Century Gothic;text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span  class='underline'id="<%=gknamestr%>" style="font-family: Century Gothic;font-size: 15px "><%=gkname.get(1)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="<%=gkteamstr%>" style="font-family: Century Gothic;font-size: 12px; font-weight: lighter "><%=gkteam.get(1)%></span>
                                            </div>
                                        </td>
                                        <td id="<%=gkpricestr%>" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%= gkprice.get(1)%></td>
                                        <td id="<%=gkscorestr%>" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%= gkscore.get(1)%></td>
                                    </tr>
                                ...
                                <table style="width:100%; background-color: #f9f5f5" id='def'>
                                    ...
                                    <tr id="def1" style='cursor:pointer' onclick="openModalDEF(1)">
                                        ...
                                        <td style=" font-family: Century Gothic;text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="namedef1" style="font-family: Century Gothic;font-size: 15px; "><%=defname.get(0)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="teamdef1" style="font-family: Century Gothic;font-size: 12px; font-weight: lighter "><%=defteam.get(0)%></span>
                                            </div>
                                        </td>
                                        <td id="pricedef1" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%=defprice.get(0)%></td>
                                        <td id="scoredef1" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%=defscore.get(0)%></td>
                                    </tr>
                                    <tr id="def2" style='cursor:pointer'onclick="openModalDEF(2)">
                                        ...
                                        <td style="font-family: Century Gothic;text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="namedef2" style="font-family: Century Gothic;font-size: 15px; "><%=defname.get(1)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="teamdef2" style="font-family: Century Gothic;font-size: 12px; font-weight: lighter "><%=defteam.get(1)%></span>
                                            </div>
                                        </td>
                                        <td id="pricedef2" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%=defprice.get(1)%></td>
                                        <td id="scoredef2" style="font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%=defscore.get(1)%></td>
                                    </tr>
                                    <tr id="def3" style='cursor:pointer' onclick="openModalDEF(3)">
                                        ...
                                        <td style="font-family: Century Gothic;text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="namedef3" style="font-family: Century Gothic;font-size: 15px; "><%=defname.get(2)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="teamdef3" style="font-family: Century Gothic;font-size: 12px; font-weight: lighter "><%=defteam.get(2)%></span>
                                            </div>
                                        </td>
                                        <td id="pricedef3" style="font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%=defprice.get(2)%></td>
                                        <td id="scoredef3" style="font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%=defscore.get(2)%></td>
                                    </tr>
                                    <tr id="def4" style='cursor:pointer' onclick="openModalDEF(4)">
                                        ...
                                        <td style='font-size: 14px;border-bottom:1px solid white;width: 10%;text-align: center  '><span id="definjury4" class="glyphicon glyphicon-alert fa-lg" style="color:#c0020d"></span></td>
                                            <% }
                                            %>
                                        <td style="font-family: Century Gothic; font-family: Century Gothic;text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            <div class='col-sm-2' style="width:37px;height: 30px">
                                                <img id="imagedef4" src="img/<%=def.get(3)%>" style="width:31px;height:30px;float:right" />
                                            </div>
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="namedef4" style="font-family: Century Gothic;font-size: 15px; "><%=defname.get(3)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="teamdef4" style="font-family: Century Gothic;font-size: 12px; font-weight: lighter "><%=defteam.get(3)%></span>
                                            </div>
                                        </td>
                                        <td id="pricedef4" style="font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%=defprice.get(3)%></td>
                                        <td id="scoredef4" style="font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  "><%=defscore.get(3)%></td>
                                    </tr>
                                    <tr id="def5" style='cursor:pointer' onclick="openModalDEF(5)">
                                        ...
                                        <td style=" font-family: Century Gothic;text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="namedef5" style="font-family: Century Gothic;font-size: 15px; "><%=defname.get(4)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="teamdef5" style="font-family: Century Gothic;font-size: 12px; font-weight: lighter "><%=defteam.get(4)%></span>
                                            </div>
                                        </td>
                                        <td id="pricedef5" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%=defprice.get(4)%></td>
                                        <td id="scoredef5" style="font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%=defscore.get(4)%></td>
                                    </tr>
                                    <tr id="def6" style='cursor:pointer' onclick="openModalDEF(6)">
                                        ...
                                        <td style="font-family: Century Gothic; text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="namedef6" style="font-family: Century Gothic;font-size: 15px; "><%=defname.get(5)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="teamdef6" style="font-family: Century Gothic;font-size: 12px; font-weight: lighter "><%=defteam.get(5)%></span>
                                            </div>
                                        </td>
                                        <td id="pricedef6" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%=defprice.get(5)%></td>
                                        <td id="scoredef6" style="font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%=defscore.get(5)%></td>
                                    </tr>
                                    <tr id="def7" style='cursor:pointer' onclick="openModalDEF(7)">
                                        ...
                                        <td style=" font-family: Century Gothic;text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="namedef7" style="font-family: Century Gothic;font-size: 15px; "><%=defname.get(6)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="teamdef7" style="font-family: Century Gothic;font-size: 12px; font-weight: lighter "><%=defteam.get(6)%></span>
                                            </div>
                                        </td>
                                        <td id="pricedef7" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%=defprice.get(6)%></td>
                                        <td id="scoredef7" style="font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%=defscore.get(6)%></td>
                                    </tr>
                                    <tr id="def8" style='cursor:pointer' onclick="openModalDEF(8)">
                                        ...
                                        <td style="font-family: Century Gothic; text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="namedef8" style="font-family: Century Gothic;font-size: 15px; "><%=defname.get(7)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="teamdef8" style="font-family: Century Gothic;font-size: 12px; font-weight: lighter "><%=defteam.get(7)%></span>
                                            </div>
                                        </td>
                                        <td id="pricedef8" style="font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%=defprice.get(7)%></td>
                                        <td id="scoredef8" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%=defscore.get(7)%></td>
                                    </tr>
                                    <%
                                        String defstr;
                                        String defimagestr;
                                    ...
                                    <tr id='<%=defstr%>' style='display:none;cursor:pointer' onclick="openModalDEF(<%=i%>)">
                                        ...
                                        <td style=" font-family: Century Gothic;text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="<%=defnamestr%>" style="font-family: Century Gothic;font-size: 15px; "><%=defname.get(1)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="<%=defteamstr%>" style="font-family: Century Gothic;font-size: 12px; font-weight: lighter "><%=defteam.get(1)%></span>
                                            </div>
                                        </td>
                                        <td id="<%=defpricestr%>" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%= defprice.get(1)%></td>
                                        <td id="<%=defscorestr%>" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%= defscore.get(1)%></td>
                                    </tr>
                                ...
                                <table style="width:100%; background-color: #f9f5f5" id='mid'>
                                    ...
                                    <tr id='mid1' style='cursor:pointer'  onclick="openModalMID(1)">
                                        ...
                                        <td style="font-family: Century Gothic; text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="namemid1" style="font-family: Century Gothic;font-size: 15px; "><%=midname.get(0)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="teammid1" style="font-family: Century Gothic;font-size: 12px; font-weight: lighter "><%=midteam.get(0)%></span>
                                            </div>
                                        </td>
                                        <td id="pricemid1" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%=midprice.get(0)%></td>
                                        <td id="scoremid1" style="font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%=midscore.get(0)%></td>
                                    </tr>
                                    <tr id='mid2' style='cursor:pointer' onclick="openModalMID(2)">
                                        ...
                                        <td style=" font-family: Century Gothic;text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="namemid2" style="font-family: Century Gothic;font-size: 15px; "><%=midname.get(1)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="teammid2" style="font-family: Century Gothic;font-size: 12px; font-weight: lighter "><%=midteam.get(1)%></span>
                                            </div>
                                        </td>
                                        <td id="pricemid2" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%=midprice.get(1)%></td>
                                        <td id="scoremid2" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%=midscore.get(1)%></td>
                                    </tr>
                                    <tr id="mid3" style='cursor:pointer' onclick="openModalMID(3)" >
                                        ...
                                        <td style=" font-family: Century Gothic;text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="namemid3" style="font-family: Century Gothic;font-size: 15px; "><%=midname.get(2)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="teammid3" style="font-family: Century Gothic;font-size: 12px; font-weight: lighter "><%=midteam.get(2)%></span>
                                            </div>
                                        </td>
                                        <td id="pricemid3" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%=midprice.get(2)%></td>
                                        <td id="scoremid3" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%=midscore.get(2)%></td>
                                    </tr>
                                    <tr id="mid4" style='cursor:pointer' onclick="openModalMID(4)">
                                        ...
                                        <td style=" font-family: Century Gothic;text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="namemid4" style="font-family: Century Gothic;font-size: 15px; "><%=midname.get(3)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="teammid4" style="font-family: Century Gothic;font-size: 12px; font-weight: lighter "><%=midteam.get(3)%></span>
                                            </div>
                                        </td>
                                        <td id="pricemid4" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%=midprice.get(3)%></td>
                                        <td id="scoremid4" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%=midscore.get(3)%></td>
                                    </tr>
                                    <tr id="mid5" style='cursor:pointer' onclick="openModalMID(5)">
                                        ...
                                        <td style="font-family: Century Gothic;text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="namemid5" style="font-family: Century Gothic;font-size: 15px; "><%=midname.get(4)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="teammid5" style="font-family: Century Gothic;font-size: 12px; font-weight: lighter "><%=midteam.get(4)%></span>
                                            </div>
                                        </td>
                                        <td id="pricemid5" style="font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%=midprice.get(4)%></td>
                                        <td id="scoremid5" style="font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%=midscore.get(4)%></td>
                                    </tr >
                                    ...
                                    <tr id='<%=midstr%>' style='display:none;cursor:pointer' onclick="openModalMID(<%=i%>)">
                                        ...
                                        <td style=" font-family: Century Gothic;text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="<%=midnamestr%>" style="font-family: Century Gothic;font-size: 15px; "><%=midname.get(1)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="<%=midteamstr%>" style="font-family: Century Gothic;font-size: 12px; font-weight: lighter "><%=midteam.get(1)%></span>
                                            </div>
                                        </td>
                                        <td id="<%=midpricestr%>" style=" font-family: Century Gothic;text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%= midprice.get(1)%></td>
                                        <td id="<%=midscorestr%>" style="font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%= midscore.get(1)%></td>
                                    </tr>
                                ...
                                <table style="width:100%; background-color: #f9f5f5" id='fwd'>
                                    ...
                                    <tr id="fwd1" style='cursor:pointer' onclick="openModalFWD(1)">
                                        ...
                                        <td style="font-family: Century Gothic;  text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="namefwd1" style="font-family: Century Gothic; font-size: 15px; "><%=fwdname.get(0)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="teamfwd1" style="font-family: Century Gothic; font-size: 12px; font-weight: lighter "><%=fwdteam.get(0)%></span>
                                            </div>
                                        </td>
                                        <td id="pricefwd1" style="font-family: Century Gothic;  text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%=fwdprice.get(0)%></td>
                                        <td id="scorefwd1" style="font-family: Century Gothic;  text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%=fwdscore.get(0)%></td>
                                    </tr>
                                    <tr id="fwd2" style='cursor:pointer' onclick="openModalFWD(2)">
                                        ...
                                        <td style=" text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="namefwd2" style="font-family: Century Gothic; font-size: 15px; "><%=fwdname.get(1)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="teamfwd2" style="font-family: Century Gothic; font-size: 12px; font-weight: lighter "><%=fwdteam.get(1)%></span>
                                            </div>
                                        </td>
                                        <td id="pricefwd2" style=" font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%=fwdprice.get(1)%></td>
                                        <td id="scorefwd2" style=" font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%=fwdscore.get(1)%></td>
                                    </tr>
                                    <tr id="fwd3" style='cursor:pointer' onclick="openModalFWD(3)">
                                        ...
                                        <td style=" text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="namefwd3" style="font-family: Century Gothic; font-size: 15px; "><%=fwdname.get(2)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="teamfwd3" style="font-family: Century Gothic; font-size: 12px; font-weight: lighter "><%=fwdteam.get(2)%></span>
                                            </div>
                                        </td>
                                        <td id="pricefwd3" style=" font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%=fwdprice.get(2)%></td>
                                        <td id="scorefwd3" style=" font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%=fwdscore.get(2)%></td>
                                    </tr>
                                    <tr id="fwd4" style='cursor:pointer' onclick="openModalFWD(4)">
                                        ...
                                        <td style=" text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="namefwd4" style="font-family: Century Gothic; font-size: 15px; "><%=fwdname.get(3)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="teamfwd4" style="font-family: Century Gothic; font-size: 12px; font-weight: lighter "><%=fwdteam.get(3)%></span>
                                            </div>
                                        </td>
                                        <td id="pricefwd4" style=" font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%=fwdprice.get(3)%></td>
                                        <td id="scorefwd4" style=" font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%=fwdscore.get(3)%></td>
                                    </tr>
                                    <tr id="fwd5" style='cursor:pointer' onclick="openModalFWD(5)">
                                        ...
                                        <td style=" text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="namefwd5" style="font-family: Century Gothic; font-size: 15px; "><%=fwdname.get(4)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="teamfwd5" style="font-family: Century Gothic; font-size: 12px; font-weight: lighter "><%=fwdteam.get(4)%></span>
                                            </div>
                                        </td>
                                        <td id="pricefwd5" style=" font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%=fwdprice.get(4)%></td>
                                        <td id="scorefwd5" style=" font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%=fwdscore.get(4)%></td>
                                    </tr>
                                    ...
                                    <tr id='<%=fwdstr%>' style='display:none;cursor:pointer' onclick="openModalFWD(<%=i%>)">
                                        ...
                                        <td style=" text-align: left ;font-size:14px; font-weight: bold; border-bottom:1px solid white; padding: 5px;width: 60% ">
                                            ...
                                            <div class='col-sm-10' style="width:80%;height: 30px;right: 15px;margin-top:-3px; ">
                                                <span class='underline' id="<%=fwdnamestr%>" style="font-family: Century Gothic; font-size: 15px; "><%=fwdname.get(1)%></span><hr style="border:none;margin-top: -17%">
                                                <span id="<%=fwdteamstr%>" style="font-family: Century Gothic; font-size: 12px; font-weight: lighter "><%=fwdteam.get(1)%></span>
                                            </div>
                                        </td>
                                        <td id="<%=fwdpricestr%>" style=" font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%  ">$<%= fwdprice.get(1)%></td>
                                        <td id="<%=fwdscorestr%>" style=" font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%     "><%= fwdscore.get(1)%></td>
                                    </tr>
                                ...
                                <table id="search" style="width:100%; background-color: #f9f5f5;display: none">
                                    ...
                                    <tr id="<%=search%>" style='display: none;cursor:pointer' onclick="searchModal(<%=i%>)">
                                        ...
                                        <td id="<%=srchscore%>" style=" font-family: Century Gothic; text-align: center ;font-size:14px; font-weight: lighter; border-bottom:1px solid white;width: 15.5%"></td>
                                    </tr>
                                    <% }
                                    %>
                                </table>        
