    ...
    <div class="container">
        <div class="side-gap">
            ...
            <div class="col-md-9 top-gap">
                <div class="row ">
                    <h3 class="col-md-12 col-xs-12"  style="font-family: Century Gothic">Dream Team</h3>
                    <div  class="col-md-12">
<!--                        <button id="prevDream" value="<%=(fixNo - 3)%>" onclick="prevDreamfun();" type="button" class="prevbutton btncustom col-sm-3 hidden-xs" style="height: 33px; font-size: 13px; font-weight: bold; text-align: center; font-family:Century Gothic">
                            Previous
                        </button>
                                                    <h4 id="gameweekDream" class="col-sm-6 hidden-xs" style="text-align: center;font-weight: bold; font-family:Century Gothic;font-size:22px;left: 8% ">
                                                        Gameweek <%=(fixNo - 1)%> 
                                                    </h4>
                        <button id="nextDream" onclick="nextDreamfun()" type="button" class="btncustom nextbtn col-sm-3 hidden-xs" style="height: 33px; font-size: 13px; font-weight: bold; text-align: center; font-family:Century Gothic " disabled>
                            Next
                        </button>
                        ...
                        <div class="row hidden-sm hidden-md hidden-lg">
                            ...
                            <button type="button" class="btncustom nextbtn col-sm-3" style="width:150px; height: 33px; font-size: 13px; font-weight: bold; text-align: center; font-family:Century Gothic;display:none">
                                Next
                            </button>
                        </div>-->
                        <div class="col-md-12" style="margin-top: 2%;width: 100%;background-color:#050424">
                            <button id="prevDream" value="<%=(fixNo - 3)%>" onclick="prevDreamfun();" type="button" class="prevbtn btncstm col-sm-3 hidden-xs" style="float: left;margin-left: -15px;" >
                                Previous
                            </button>
                            <h6 id="gameweekDream" class="col-md-6" style="color:white;font-size: 20px;text-align: center; font-weight: bold;margin: 8px;font-family: Century Gothic;width: 67.45%;">
                                Gameweek <%=(fixNo - 1)%> 
                            </h6>
                            <button id="nextDream" onclick="nextDreamfun()" type="button" class="nextbtn btncstm col-sm-3 hidden-xs" style="float: right;margin-right: -15px;" disabled>
                                Next
                            </button>
                            <h6 id="gameweekDream" class="hidden-sm hidden-md hidden-lg" style="color:white;font-size: 20px;text-align: center; font-weight: bold;margin: 8px;font-family: Century Gothic;width: 67.45%;">
                                Gameweek <%=(fixNo - 1)%> 
                            </h6>
                            <div class="row hidden-sm hidden-md hidden-lg">
                        ...
                        <div class="col-sm-12" style="width: 100%;border: 1px solid #ebebe4;margin-bottom: 2%;padding-left: 0;padding-right: 0" >
                            <div class="col-md-6 col-xs-6" style="width: 40%;flex: 1;margin-top: 0.5%;margin-bottom: 0.5%">
                                <p style="font-family: Century Gothic;font-size:18px; font-weight: bold;margin-top: 28px; margin-bottom: 0px" align="center">
                                    Total Points
                                </p>
                                <p id="totalScoreDream" style="color:#db1b1b;font-weight:bold;font-family: Century Gothic; font-size: 45px;    margin: 0px 6px 20px;" align="center">
                                    <%=dream.gettotalScore()%>
                                </p>
                            </div>

                            <div class="col-md-6 col-xs-6" style="width: 60%;flex: 1;margin-top: 0.5%;margin-bottom: 0.5%;border-left: 1px solid #ebebe4">
                                ...
                                <div class="col-md-6" style="font-family: Century Gothic; font-weight: lighter">
                                    <p id="bestName" style="margin: 0px 6px 4px;margin-top: 9%;" >
                                        Sam Kerr
                                    </p>
