                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-9" style="margin-top: 10px">
                            <div class="col-md-12 col-sm-6 col-xs-12 fixtures" id="somediv">
                                ...
                                <button id="prevFix" value="<%=posts.get(1)%>" type="button" class="fixturebtn btncstm col-sm-3 hidden-xs" style="font-family: Century Gothic;font-size: 14px; font-weight: bold; text-align: center;padding: 1%; margin-top: -4%;float: left">
                                    Previous
                                </button>
                                <h5 class="col-sm-6 hidden-xs" style="font-family: Century Gothic;text-align: center;font-weight: bold; font-size:18px;width: 68%;margin-top: -1%;margin-bottom: -1%" align="center">
                                ...
                                %>
                                <button id="nextFix" value="<%=posts.get(2)%>" type="button" class="fixturebtn btncstm col-sm-3 hidden-xs" style="font-family: Century Gothic;font-size: 14px; font-weight: bold; text-align: center; padding: 1%;margin-top: -9.15%;float: right;" <%=displaynext%>>
                                    Next
                                </button>
                                <div id="first">
                                    <%
                                    ...
                                    <a data-toggle="collapse" href="#<%=game%>" style="color:black">
                                        <div class="match col-sm-12 " style="display: block;box-sizing: border-box;padding: .5rem 2rem .5rem 2rem;border-bottom: 2px solid #e8e4e4" >
                                            <div class="row" style="">
                                            ...
                                            <h6 class="col-sm-12" style="color:black;font-family: Century Gothic;font-weight: lighter;font-size: 14px;margin-top: -4%;text-align: center;"><%=stadium.get(i)%></h6>
