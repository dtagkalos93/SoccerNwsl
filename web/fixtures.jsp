                                    ...
                                    <div id="monday">
                                        ...
                                        <a id="<%=mondaygame + "id"%>" data-toggle="collapse" href="#<%=mondaygame%>" style="color:black">
                                            <div class="match col-sm-12 " style="display: block;box-sizing: border-box;padding: .5rem 2rem .5rem 2rem;border-bottom: 1px solid #e8e4e4" >
                                                ...
                                                <h6 id="mondaystadium<%=i%>" class="col-sm-12" style="color:black;font-family: Century Gothic;font-weight: lighter;font-size: 17px;text-align: center;"><%=stadium.get(i)%></h6>
                                    ...
                                    <div id="tuesday">
                                        ...
                                        <a id="<%= tuesdaygame + "id"%>" data-toggle="collapse" href="#<%= tuesdaygame%>" style="color:black">
                                            <div class="match col-sm-12 " style="display: block;box-sizing: border-box;padding: .5rem 2rem .5rem 2rem;border-bottom: 1px solid #e8e4e4" >
                                                ...
                                                <h6 id="tuesdaystadium<%=i%>" class="col-sm-12" style="color:black;font-family: Century Gothic;font-weight: lighter;font-size: 17px;text-align: center;"><%=stadium.get(i)%></h6>
                                    ...
                                    <div id="wednesday">
                                        ...
                                        <a id="<%= wednesdaygame + "id"%>" data-toggle="collapse" href="#<%= wednesdaygame%>" style="color:black">
                                            <div class="match col-sm-12 " style="display: block;box-sizing: border-box;padding: .5rem 2rem .5rem 2rem;border-bottom: 1px solid #e8e4e4" >
                                                ...
                                                <h6 id="wednesdaystadium<%=i%>" class="col-sm-12" style="color:black;font-family: Century Gothic;font-weight: lighter;font-size: 17px;text-align: center;"><%=stadium.get(i)%></h6>
                                    ...
                                    <div id="thursday">
                                        ...
                                        <a id="<%= thursdaygame + "id"%>" data-toggle="collapse" href="#<%= thursdaygame%>" style="color:black">
                                            <div class="match col-sm-12 " style="display: block;box-sizing: border-box;padding: .5rem 2rem .5rem 2rem;border-bottom: 1px solid #e8e4e4" >
                                                ...
                                                <h6 id="thursdaystadium<%=i%>" class="col-sm-12" style="color:black;font-family: Century Gothic;font-weight: lighter;font-size: 17px;text-align: center;"><%=stadium.get(i)%></h6>
                                    ...
                                    <div id="friday">
                                        ...
                                        <a id="<%= fridaygame + "id"%>" data-toggle="collapse" href="#<%= fridaygame%>" style="color:black">
                                            <div class="match col-sm-12 " style="display: block;box-sizing: border-box;padding: .5rem 2rem .5rem 2rem;border-bottom: 1px solid #e8e4e4" >
                                                ...
                                                <h6 id="fridaystadium<%=i%>" class="col-sm-12" style="color:black;font-family: Century Gothic;font-weight: lighter;font-size: 17px;text-align: center;"><%=stadium.get(i)%></h6>
                                    ...
                                    <div id="saturday">
                                        ...
                                        <a id="<%=saturdaygame + "id"%>" data-toggle="collapse" href="#<%=saturdaygame%>" style="color:black">
                                            <div class="match col-sm-12 " style="display: block;box-sizing: border-box;padding: .5rem 2rem .5rem 2rem;border-bottom: 1px solid #e8e4e4" >
                                                ...
                                                <h6 id="saturdaystadium<%=i%>" class="col-sm-12" style="color:black;font-family: Century Gothic;font-weight: lighter;font-size: 17px;text-align: center;"><%=stadium.get(i)%></h6>
                                        ...
                                        <a id="<%=sundaygame + "id"%>" data-toggle="collapse" href="#<%=sundaygame%>" style="color:black">
                                            <div class="match col-sm-12 " style="display: block;box-sizing: border-box;padding: .5rem 2rem .5rem 2rem;border-bottom: 1px solid #e8e4e4" >
                                                ...
                                                <h6 id="sundaystadium<%=i%>" class="col-sm-12" style="color:black;font-family: Century Gothic;font-weight: lighter;font-size: 17px;text-align: center;"><%=stadium.get(i)%></h6>
